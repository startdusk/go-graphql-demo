...
func (_m *AuthTokenService) CreateRefreshToken(ctx context.Context, user data.User, tokenID string) (string, error) {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, data.User, string) error); ok {
